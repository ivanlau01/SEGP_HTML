...
$connection=mysqli_connect('localhost','root','','csv_db 7') or die(mysqli_error(die));
//select a database for given connection
//if database selection  fails stop further execution and show mysql error
mysqli_select_db($connection,'csv_db 7') or die(mysqli_error(die));
...
<table class="library-table">
  ...
  <tr>
    ...
    <td data-label="Simi_percentage(%):"><?php echo $row->similarity_percentage; // row first name ?></td>
